		...
		<div id="inicio" style="background-image: url('<?php echo get_template_directory_uri() . '/images/VT_hero_home.jpg' ?>');">
				<div class="marketing">
					...
					<figure class="onihero">
						<img src="<?php echo get_template_directory_uri() . '/images/dispositivo-oni.png'?>" alt="">
				</figure>
				</div>
			</div>
	</section>
...
<section class="blog-2 section section-gray" style="background-color:#f1f5ff">
	<div class="container">
		<div class="row">
			<h2 class="title" style="text-align:center;font-size: 27px;color: #2f68f0;">See our Case Studies</h2>
			<div class="row">
