...
*/
?>
<section class="suscription" style="background-color: #2f69f0;color: white;padding: 100px 12%;">	
	<div style="font-size: 9px;margin: 0px 70px;display: inline-block;">
		<h1 style="color: white;">Subscribe for updates</h1>
		<p style="width: 86%;">Get our new releases, developments and applications in your inbox.</p>
	</div>
